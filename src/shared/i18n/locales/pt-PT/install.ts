export default {
  ...
  installingHermes: "A instalar o Agentify AI Agent",
  ...
  confirmLocationLabel: "O Agentify AI será instalado em:",
  confirmFresh:
  ...
  confirmInstallBtn: "Instalar o Agentify AI",
  ...
  useExistingQuitBtn: "Sair do Agentify AI",
} as const;
