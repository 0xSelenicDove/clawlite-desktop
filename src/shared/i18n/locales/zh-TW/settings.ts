export default {
  ...
  analytics: {
    label: "傳送匿名使用情況分析",
    hint: "透過向專案的 PostHog 執行個體（位於歐盟）傳送匿名、彙總的使用資料，協助改進 ClawLite。您隨時可以關閉此功能。",
    disclosure: {
  ...
  empty: "(空)",
  dataSection: "資料",
  dataHint: "匯出或匯入你的 ClawLite 設定、工作階段、技能和記憶。",
  backingUp: "正在備份...",
  exportBackup: "匯出備份",
  importing: "正在匯入...",
  importBackup: "匯入備份",
  ...
  modeLocal: "本機",
  modeRemote: "遠端",
  modeLocalHint: "使用本機安裝的 ClawLite",
  modeRemoteHint: "連線到網路或雲伺服器上的 ClawLite API",
  remoteUrl: "遠端伺服器位址",
  remoteUrlHint:
