export default {
  ...
  installingHermes: "正在安裝 ClawLite Agent",
  ...
  confirmTitle: "安裝前確認",
  confirmLocationLabel: "ClawLite 將安裝到：",
  confirmFresh: "此處未找到現有安裝 — 將進行全新安裝。",
  confirmUpdate: "此處已有 ClawLite 安裝 — 將更新到最新版本。",
  confirmReplace:
    "此處存在一個資料夾，但不是有效的 Hermes 安裝 — 安裝將刪除並取代它。",
  confirmNotInherited:
    "如果你在其他位置或透過命令列安裝過 Hermes，那些安裝不會被沿用。",
  confirmInstallBtn: "安裝 ClawLite",
  useExistingBtn: "使用現有安裝",
  useExistingHint:
    "選擇包含你現有 Hermes 安裝的資料夾（即包含 hermes-agent 資料夾的那個）。",
  useExistingInvalid: "在該資料夾中未找到可用的 ClawLite 安裝。",
  useExistingDone: "已設定現有安裝 — 結束並重新開啟 ClawLite 以套用。",
  useExistingQuitBtn: "結束 ClawLite",
} as const;
