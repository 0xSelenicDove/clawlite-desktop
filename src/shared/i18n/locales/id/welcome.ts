export default {
  title: "Selamat datang di ClawLite",
  subtitle:
  ...
  dividerOr: "atau",
  connectRemote: "Hubungkan ke ClawLite Remote",
  connectRemoteTitle: "Hubungkan ke ClawLite Remote",
  connectRemoteSubtitle: "Masukkan URL server ClawLite API yang sedang berjalan.",
