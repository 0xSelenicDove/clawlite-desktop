export default {
  ...
  dividerOr: "lub",
  connectRemote: "Połącz ze zdalnym Agentify AI",
  connectRemoteTitle: "Połącz ze zdalnym Agentify AI",
  connectRemoteSubtitle: "Podaj URL działającego serwera API Agentify AI.",
