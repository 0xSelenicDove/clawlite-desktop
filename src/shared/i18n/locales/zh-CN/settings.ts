export default {
  ...
  analytics: {
    label: "发送匿名使用情况分析",
    hint: "通过向项目的 PostHog 实例（托管于欧盟）发送匿名、聚合的使用数据来帮助改进 ClawLite。您可以随时关闭。",
    disclosure: {
  ...
  empty: "(空)",
  dataSection: "数据",
  dataHint: "导出或导入你的 ClawLite 配置、会话、技能和记忆。",
  backingUp: "正在备份...",
  exportBackup: "导出备份",
  importing: "正在导入...",
  importBackup: "导入备份",
  ...
  modeLocal: "本地",
  modeRemote: "远程",
  modeLocalHint: "使用本机安装的 ClawLite",
  modeRemoteHint: "连接到网络或云服务器上的 ClawLite API",
  remoteUrl: "远程服务器地址",
  remoteUrlHint:
