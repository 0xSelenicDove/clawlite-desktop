export default {
  ...
  analytics: {
    ...
    hint: "Helps improve Agentify AI by sending anonymous, aggregated usage data to the project's PostHog instance. You can turn this off at any time.",
    disclosure: {
  ...
  updateSuccess: "Agentify AI updated successfully.",
  ...
  migrating: "Migrating...",
  migrateToHermes: "Migrate to Agentify AI",
  skip: "Skip",
  ...
  modeLocal: "Local",
  modeRemote: "Remote",
  modeLocalHint: "Using Agentify AI installed on this device",
  modeRemoteHint: "Connect to a Agentify AI API server on your network or cloud",
  ...
  communityHint: "Join our Discord channel to ask questions, report issues, and chat with other Agentify AI users.",
  joinDiscord: "Join Discord Channel",

  // SSH & Server Config
  modeSsh: "SSH Tunnel",
  modeSshHint: "Tunnel to a remote Agentify AI over SSH — no exposed ports or API keys needed.",
  ...
  remoteEnvSshDesc: "SSH mode: add API_SERVER_KEY=<your-key> to ~/.agentify-ai/profiles/<profile>/.env on the remote host, then restart the gateway there.",
  remoteEnvDesc: "Remote mode: add API_SERVER_KEY=<your-key> to the .env on your remote Agentify AI server, then restart the gateway.",
  sshHost: "SSH Host",
  sshPort: "SSH Port",
  sshUsername: "Username",
  sshKeyPath: "Private Key Path",
  sshKeyPathOptional: "(optional, defaults to ~/.ssh/id_rsa)",
  sshRemotePort: "Remote Agentify AI Port",
  ...
  sshSubtitle: "Tunnel to a remote Agentify AI over SSH — no exposed ports or API keys needed.",
  ...
  sshErrorConnection: "Could not connect via SSH or reach Agentify AI on the remote. Make sure:\n• SSH key is correct (or default ~/.ssh/id_rsa works)\n• Agentify AI gateway is running on the remote\n• The remote port is correct (default 8642)",
