export default {
  ...
  analytics: {
    ...
    hint: "Helps improve ClawLite by sending anonymous, aggregated usage data to the project's PostHog instance. You can turn this off at any time.",
    disclosure: {
  ...
  updateSuccess: "ClawLite updated successfully.",
  ...
  migrating: "Migrating...",
  migrateToHermes: "Migrate to ClawLite",
  skip: "Skip",
  ...
  modeLocal: "Local",
  modeRemote: "Remote",
  modeLocalHint: "Using ClawLite installed on this device",
  modeRemoteHint: "Connect to a ClawLite API server on your network or cloud",
  ...
  communityHint: "Join our Discord channel to ask questions, report issues, and chat with other ClawLite users.",
  joinDiscord: "Join Discord Channel",

  // SSH & Server Config
  modeSsh: "SSH Tunnel",
  modeSshHint: "Tunnel to a remote ClawLite over SSH — no exposed ports or API keys needed.",
  ...
  remoteEnvSshDesc: "SSH mode: add API_SERVER_KEY=<your-key> to ~/.clawlite/profiles/<profile>/.env on the remote host, then restart the gateway there.",
  remoteEnvDesc: "Remote mode: add API_SERVER_KEY=<your-key> to the .env on your remote ClawLite server, then restart the gateway.",
  sshHost: "SSH Host",
  sshPort: "SSH Port",
  sshUsername: "Username",
  sshKeyPath: "Private Key Path",
  sshKeyPathOptional: "(optional, defaults to ~/.ssh/id_rsa)",
  sshRemotePort: "Remote ClawLite Port",
  ...
  sshSubtitle: "Tunnel to a remote ClawLite over SSH — no exposed ports or API keys needed.",
  ...
  sshErrorConnection: "Could not connect via SSH or reach ClawLite on the remote. Make sure:\n• SSH key is correct (or default ~/.ssh/id_rsa works)\n• ClawLite gateway is running on the remote\n• The remote port is correct (default 8642)",
