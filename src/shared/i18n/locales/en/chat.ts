export default {
  ...
  reasoningEffort: {
    ...
    auto: "Auto",
    autoDescription: "Let ClawLite and the model decide.",
  ...
  deny: "Deny",
  clarify: {
    defaultQuestion: "ClawLite needs your input.",
    placeholder: "Type your answer…  (Ctrl+Enter to send)",
    send: "Send",
    skip: "Skip — let ClawLite decide",
    skipped: "Skipped — ClawLite decided",
