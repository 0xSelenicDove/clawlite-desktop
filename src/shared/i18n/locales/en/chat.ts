export default {
  ...
  reasoningEffort: {
    ...
    auto: "Auto",
    autoDescription: "Let Agentify AI and the model decide.",
  ...
  deny: "Deny",
  clarify: {
    defaultQuestion: "Agentify AI needs your input.",
    placeholder: "Type your answer…  (Ctrl+Enter to send)",
    send: "Send",
    skip: "Skip — let Agentify AI decide",
    skipped: "Skipped — Agentify AI decided",
  ...
  commands: {
    ...
    version: "Show Agentify AI version",
  },
