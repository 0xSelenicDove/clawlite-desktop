export default {
  title: "Agentify AI'e Hoş Geldiniz",
  subtitle:
  ...
  dividerOr: "veya",
  connectRemote: "Uzak Agentify AI'e Bağlan",
  connectRemoteTitle: "Uzak Agentify AI'e Bağlan",
  connectRemoteSubtitle: "Çalışan bir Agentify AI API sunucusunun URL'sini girin.",
