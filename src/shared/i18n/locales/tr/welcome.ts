export default {
  ...
  dividerOr: "veya",
  connectRemote: "Uzak ClawLite'e Bağlan",
  connectRemoteTitle: "Uzak ClawLite'e Bağlan",
  connectRemoteSubtitle: "Çalışan bir ClawLite API sunucusunun URL'sini girin.",
