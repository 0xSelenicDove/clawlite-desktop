export default {
  ...
  analytics: {
    ...
    hint: "ClawLite'ı iyileştirmeye yardımcı olmak için anonim, toplulaştırılmış kullanım verilerini projenin PostHog örneğine gönderir. İstediğiniz zaman kapatabilirsiniz.",
    disclosure: {
  ...
  updateSuccess: "ClawLite başarıyla güncellendi.",
  ...
  migrating: "Taşınıyor...",
  migrateToHermes: "ClawLite'e Taşı",
  skip: "Geç",
  ...
  modeLocal: "Yerel",
  modeRemote: "Uzak",
  modeLocalHint: "Bu cihazda yüklü ClawLite kullanılıyor",
  modeRemoteHint:
  ...
  communityHint: "Sorular sormak, sorunları bildirmek ve diğer ClawLite kullanıcılarıyla sohbet etmek için Discord kanalımıza katılın.",
  joinDiscord: "Discord Kanalına Katıl",

  // SSH & Server Config
  modeSsh: "SSH Tüneli",
  modeSshHint: "SSH üzerinden uzak bir ClawLite'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  remoteEnvSshDesc: "SSH modu: uzak sunucudaki ~/.clawlite/profiles/<profile>/.env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından oradaki gateway'i yeniden başlatın.",
  remoteEnvDesc: "Uzak mod: uzak ClawLite sunucunuzdaki .env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından gateway'i yeniden başlatın.",
  ...
  sshRemotePort: "Uzak ClawLite Portu",
  ...
  sshSubtitle: "SSH üzerinden uzak bir ClawLite'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  sshErrorConnection: "SSH üzerinden bağlanılamadı veya uzaktaki ClawLite'e ulaşılamadı. Şunlardan emin olun:\n• SSH anahtarı doğru (veya varsayılan ~/.ssh/id_rsa çalışıyor)\n• Uzak sunucuda ClawLite gateway'i çalışıyor\n• Uzak port doğru (varsayılan 8642)",
