export default {
  ...
  analytics: {
    ...
    hint: "Agentify AI'ı iyileştirmeye yardımcı olmak için anonim, toplulaştırılmış kullanım verilerini projenin PostHog örneğine gönderir. İstediğiniz zaman kapatabilirsiniz.",
    disclosure: {
  ...
  updateSuccess: "Agentify AI başarıyla güncellendi.",
  ...
  migrating: "Taşınıyor...",
  migrateToHermes: "Agentify AI'e Taşı",
  skip: "Geç",
  ...
  modeLocal: "Yerel",
  modeRemote: "Uzak",
  modeLocalHint: "Bu cihazda yüklü Agentify AI kullanılıyor",
  modeRemoteHint:
  ...
  communityHint: "Sorular sormak, sorunları bildirmek ve diğer Agentify AI kullanıcılarıyla sohbet etmek için Discord kanalımıza katılın.",
  joinDiscord: "Discord Kanalına Katıl",

  // SSH & Server Config
  modeSsh: "SSH Tüneli",
  modeSshHint: "SSH üzerinden uzak bir Agentify AI'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  remoteEnvSshDesc: "SSH modu: uzak sunucudaki ~/.agentify-ai/profiles/<profile>/.env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından oradaki gateway'i yeniden başlatın.",
  remoteEnvDesc: "Uzak mod: uzak Agentify AI sunucunuzdaki .env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından gateway'i yeniden başlatın.",
  ...
  sshRemotePort: "Uzak Agentify AI Portu",
  ...
  sshSubtitle: "SSH üzerinden uzak bir Agentify AI'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  sshErrorConnection: "SSH üzerinden bağlanılamadı veya uzaktaki Agentify AI'e ulaşılamadı. Şunlardan emin olun:\n• SSH anahtarı doğru (veya varsayılan ~/.ssh/id_rsa çalışıyor)\n• Uzak sunucuda Agentify AI gateway'i çalışıyor\n• Uzak port doğru (varsayılan 8642)",
