export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o Agentify AI enviando dados de uso anônimos e agregados para a instância PostHog do projeto (hospedada na UE). Você pode desativar a qualquer momento.",
    disclosure: {
  ...
  updateSuccess: "Agentify AI atualizado com sucesso.",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o Agentify AI instalado neste dispositivo",
  modeRemoteHint:
