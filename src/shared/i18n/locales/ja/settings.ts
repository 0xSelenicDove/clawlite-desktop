export default {
  ...
  analytics: {
    ...
    hint: "プロジェクトの PostHog インスタンス（EU ホスト）に匿名・集計済みの利用状況データを送信することで Agentify AI の改善に役立てます。いつでもオフにできます。",
    disclosure: {
  ...
  migrating: "移行中...",
  migrateToHermes: "Agentify AI に移行",
  skip: "スキップ",
  ...
  modeLocal: "ローカル",
  modeRemote: "リモート",
  modeLocalHint: "このデバイスにインストールされた Agentify AI を使用",
  modeRemoteHint: "ネットワークまたはクラウド上の Agentify AI API サーバに接続",
  remoteUrl: "リモート URL",
  remoteUrlHint:
